...
user_1 = User.create(name: 'Francisco', last_name: 'Borie', email: 'fjborie@miuandes.cl', phone: '987654321', password: 'password123', address: 'San Carlos de Apoquindo 2200', admin: true)
...
event_1 = Event.create(name: 'ICPC 20188888888888', start_date: DateTime.new(2019, 06, 15), place: place_1)
event_2 = Event.create(name: 'Facebook Hackathon 2018', start_date: DateTime.new(2019, 06, 20), place: place_1)
